                  ...
                  <div className='flex'>
                    ...
                    <div>
                      <div className='flex justify-center flex-col items-center rounded-full'>
                        <div className='w-6 h-full overflow-hidden rounded-full'>
                    ...
                    <div>
                      <div className='flex justify-center flex-col items-center'>
                        <div className='w-6 h-6 bg-white rounded-full flex items-center justify-center overflow-hidden'>
                          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48" className='w-12 h-12 rounded-full'>
