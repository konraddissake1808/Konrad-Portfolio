...
function About() {
  ...
  useEffect(() => {
        const aboutWorksButton = document.getElementById('about-works-button');
                  ...
                  <div className='w-4/5 col-start-1 row-start-1' id='frontend-container'>
                    <div className='w-full flex flex-col mb-6 @3xl:flex-row @3xl:justify-between'>
                      ...
                      <div className='text-base @3xl:w-[65%] @3xl:flex @3xl:justify-end'>
                        <ul className='grid grid-cols-3 grid-rows-1 gap-4 @3xl:w-3/4'>
                          ...
                          <li className='flex items-center justify-center'>
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-full overflow-hidden'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF" className="bi bi-javascript" viewBox="0 0 16 16">
                                  <path d="M14 0a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zM9.053 7.596v3.127l-.007 1.752q0 .498-.186.752t-.556.263q-.342 0-.528-.234-.185-.234-.185-.684v-.175H6.37v.185q0 .665.253 1.113.255.45.703.674.44.225 1.016.225.88 0 1.406-.498.527-.498.527-1.485l.007-1.752V7.596zm3.808-.108q-.585 0-1.006.244a1.67 1.67 0 0 0-.634.674 2.1 2.1 0 0 0-.225.996q0 .753.293 1.182.303.42.967.732l.469.215q.438.186.625.43.185.244.185.635 0 .478-.166.703-.156.224-.527.224-.361.001-.547-.244-.186-.243-.205-.752h-1.162q.02.996.498 1.524.479.527 1.386.527.909 0 1.417-.518.507-.517.507-1.484 0-.81-.332-1.289t-1.045-.79l-.449-.196q-.39-.166-.556-.381-.166-.214-.166-.576 0-.4.165-.596.177-.195.508-.195.361 0 .508.234.156.234.176.703h1.123q-.03-.976-.498-1.484-.47-.518-1.309-.518"/>
                                </svg>
                              </div>
                              <div>
                                <p>Javascript</p>
                          ...
                          <li className='flex items-center justify-center'>
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-12 bg-white rounded-md flex items-center justify-center overflow-hidden col-start-2'>
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50" fill="#000000">
                    ...
                    <div className='mb-6 flex flex-col @3xl:flex-row @3xl:justify-between'>
                      ...
                      <div className='@3xl:w-[65%]'>
                        <ul className='grid grid-cols-4 grid-rows-2 gap-4 @3xl:grid-cols-4 @3xl:grid-rows-2'>
                          <li id='htmlContainer' className='flex items-center justify-center'>
                            <div className='flex justify-center flex-col items-center'>
                          ...
                          <li className='flex items-center justify-center'>
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-12 bg-white rounded-md flex items-center justify-center overflow-hidden'>
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50" fill="#1A1A1A">
                          ...
                          <li className='flex items-center justify-center @3xl:col-end-5'>
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-12 bg-white rounded-md flex items-center justify-center overflow-hidden'>
                    ...
                    <div className='w-full mb-6 flex flex-col @3xl:flex-row @3xl:justify-between'>
                      ...
                      <div className='@3xl:w-[65%] @3xl:flex @3xl:justify-end'>
                        <ul className='grid grid-cols-3 grid-rows-1 gap-4 @3xl:grid-cols-2 @3xl:grid-rows-1 @3xl:w-1/2'>
                          <li className='flex items-center justify-center'>
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-12 bg-white rounded-md flex items-center justify-center overflow-hidden'>
                                <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50" fill="#1A1A1A">
                    ...
                    <div className='w-full mb-6 flex flex-col @3xl:flex-row @3xl:justify-between'>
                      ...
                      <div className='@3xl:w-[65%]'>
                        <ul className='grid grid-cols-3 grid-rows-2 gap-4 @3xl:grid-cols-4 @3xl:grid-rows-1'>
                          <li className='flex items-center justify-center'>
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-12 bg-white rounded-md flex items-center justify-center overflow-hidden'>
                                <svg className='w-10 h-10' width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                          ...
                          <li className='flex items-center justify-center'>
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-12 bg-white rounded-md flex items-center justify-center overflow-hidden'>
                                <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 24 24">
                          ...
                          <li className='flex items-center justify-center text-white'>
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-12 bg-white rounded-md flex items-center justify-center overflow-hidden'>
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48" className='w-10 h-10'>
                    ...
                    <div className='w-full mb-6 flex flex-col @3xl:flex-row @3xl:justify-between'>
                      ...
                      <div className='@3xl:w-[65%]'>
                        <ul className='grid grid-cols-3 grid-rows-2 gap-4 @3xl:grid-cols-4 @3xl:grid-rows-1 @3xl:w-full'>
                          <li className='flex items-center justify-center'>
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-12 bg-white rounded-md flex items-center justify-center overflow-hidden'>
                                <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 24 24">
                          ...
                          <li className='flex items-center justify-center'>
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-12 bg-white rounded-md flex items-center justify-center overflow-hidden'>
                                <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24">
                                  <g data-name="Product Icons"><g data-name="colored-32/firestore"><g>
                                  <path className="cls-1" d="M21,13,12,9v4l9,4Zm0-7L12,2V6l9,4Z"/><polygon id="Rectangle-7" className="cls-2" points="3 6 12 2 12 6 3 10 3 6"/><polygon id="Rectangle-7-2" data-name="Rectangle-7" className="cls-2" points="3 13 12 9 12 13 3 17 3 13"/><polygon id="Rectangle-7-3" data-name="Rectangle-7" className="cls-3" points="12 18 15.37 16.5 19.88 18.5 12 22 12 18"/></g></g></g>
                                </svg>
                              </div>
                              <div>
                                <p>Firestore</p>
                          ...
                          <li className='flex items-center justify-center text-white'>
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-12 bg-white rounded-md flex items-center justify-center overflow-hidden'>
                                <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
                    ...
                    <div className='w-full mb-6 flex flex-col @3xl:flex-row @3xl:justify-between'>
                      ...
                      <div className='@3xl:w-[65%]'>
                        <ul className='grid grid-cols-3 grid-rows-2 gap-4 @3xl:grid-cols-4 @3xl:grid-rows-1 @3xl:gap-4'>
                          <li className='flex items-center justify-center'>
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-12 bg-white rounded-md flex items-center justify-center overflow-hidden'>
                                <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
                          ...
                          <li className='flex items-center justify-center'>
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-12 bg-white rounded-md flex items-center justify-center overflow-hidden'>
                                <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 128 128">
                            ...
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-12 bg-white rounded-md flex items-center justify-center overflow-hidden'>
                                <svg className='w-10 h-10' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
                                  <path fill="#000000" d="M13.894,36.994h-0.413l-2.063-2.063v-0.412l3.163-3.163h2.2l0.309,0.309v2.2L13.894,36.994z"></path>
                                  <path fill="#000000" d="M11.419,13.516v-0.413l2.063-2.063h0.413l3.163,3.163v2.2l-0.275,0.275h-2.2L11.419,13.516z"></path>
                                  <path fill="#000000" d="M29.672,30.291h-3.025l-0.241-0.241v-7.081c0-1.272-0.481-2.234-1.994-2.269	c-0.791-0.034-1.684,0-2.612,0.034l-0.138,0.137v9.144l-0.241,0.241h-3.025l-0.241-0.241V17.984l0.241-0.241h6.806	c2.647,0,4.778,2.131,4.778,4.778v7.528L29.672,30.291z"></path>
                                  <path fill="#000000" d="M14.306,25.753H2.241L2,25.513v-3.025l0.241-0.241h12.066l0.241,0.241v3.025L14.306,25.753z"></path>
                                  <path fill="#000000" d="M45.759,25.753H33.694l-0.241-0.241v-3.025l0.241-0.241h12.066L46,22.488v3.025L45.759,25.753z"></path>
                                  <path fill="#000000" d="M22.247,13.963V4.888l0.275-0.241h3.025l0.241,0.241v9.041l-0.241,0.241h-3.025L22.247,13.963z"></path>
                                  <path fill="#000000" d="M22.247,43.113v-9.041l0.241-0.241h3.025l0.241,0.241v9.041l-0.241,0.241h-3.025L22.247,43.113z"></path>
                                </svg>
                              </div>
                              <div>
                                <p>Netlify</p>
                      ...
                      <div className='@3xl:w-[65%]'>
                        <ul className='grid grid-cols-3 grid-rows-2 gap-4 @3xl:grid-cols-4 @3xl:grid-rows-1 @3xl:gap-4'>
                          ...
                          <li className='flex items-center justify-center'>
                            <div className='flex justify-center flex-col items-center'>
                              <div className='w-12 h-12 bg-white rounded-md flex items-center justify-center overflow-hidden'>
                                <svg className='w-11 h-11' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 30 30">
            ...
            <div className='w-4/5'>
              <div className='flex flex-col mb-4'>
                ...
                <div>
                  ...
                  <div className='mb-4'>
                    <p>Designed, and implemented responsive frontend interfaces for many companies' showcase websites, working in close collaboration with other developers, and designer teams.</p>
                  </div>
                  <div className='flex'>
                    <div>
                      <div className='flex justify-center flex-col items-center'>
                        <div className='w-6 h-6 bg-black rounded-full flex items-center justify-center overflow-hidden'>
                          <svg className='rounded-full' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50" fill="#FFFFFF">
                            <path d="M 45.273438 2.324219 C 45.085938 2.117188 44.816406 2 44.535156 2 L 5.464844 2 C 5.183594 2 4.914063 2.117188 4.726563 2.324219 C 4.535156 2.53125 4.441406 2.808594 4.46875 3.089844 L 7.988281 42.515625 C 8.023438 42.929688 8.3125 43.273438 8.710938 43.390625 L 24.722656 47.960938 C 24.808594 47.988281 24.902344 48 24.996094 48 C 25.089844 48 25.179688 47.988281 25.269531 47.960938 L 41.292969 43.390625 C 41.691406 43.273438 41.976563 42.929688 42.015625 42.515625 L 45.53125 3.089844 C 45.558594 2.808594 45.464844 2.53125 45.273438 2.324219 Z M 36.847656 15.917969 L 18.035156 15.917969 L 18.484375 21.007813 L 36.394531 21.007813 L 35.050781 36.050781 L 24.992188 39.089844 L 24.894531 39.058594 L 14.953125 36.046875 L 14.410156 29.917969 L 19.28125 29.917969 L 19.492188 32.296875 L 25.050781 33.460938 L 30.507813 32.296875 L 31.089844 25.859375 L 14.046875 25.859375 L 12.722656 11.054688 L 37.28125 11.054688 Z"></path>
                          </svg>
                        </div>
